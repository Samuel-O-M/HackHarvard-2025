...
function Stats() {
  ...
  const optimizeFSRSParameters = async () => {
    // Demo mode - show alert instead of optimizing
    alert('This is a frontend-only version. To optimize FSRS parameters, please self-host the backend by following the instructions at https://github.com/Samuel-O-M/HackHarvard-2025')
    
    setOptimizeMessage('This is a demo version. Please self-host the backend to optimize parameters.')
